      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link to="/">
              <img
                src="/logo.jpg"
                alt="ASLI"
                className="h-14 w-auto object-contain mb-4 hover:opacity-70 transition-opacity"
              />
            </Link>
            ...
            <div className="flex gap-5 mt-5">
              {['IG', 'TK', 'TW', 'YT'].map(s => (
                <a
                  key={s} href="#"
                  className="text-[10px] font-bold tracking-widest uppercase text-gray-300 hover:text-black transition-colors border-b border-transparent hover:border-black pb-0.5"
                >
                  {s}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {LINKS.map(({ to, label }) => (
                <li key={to}>
                  <Link to={to} className="text-sm text-gray-400 hover:text-black transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4 leading-relaxed">
              New drops and exclusive access. No spam.
            </p>
            {subscribed ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-black text-white px-4 py-3 text-xs font-bold tracking-widest uppercase hover:opacity-70 transition-opacity"
                >
                  →
                </button>
              </form>
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <img src="/logo.jpg" alt="ASLI" className="h-6 w-auto object-contain opacity-40" />
            <span className="text-[11px] text-gray-300 tracking-wider">© 2025 ASLI. All rights reserved.</span>
          </div>
